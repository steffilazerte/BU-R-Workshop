...
dir <- "~/Projects/Teaching/R Workshop/Lessons"
...
labs <- tribble(
  ...
  "5_statistics.Rmd",                   "5 Basic Statistics",                  FALSE,
  "6_getting_help.Rmd",                 "6 Getting Help",                      TRUE) %>%
...
if(post) {
  ...
  # MOVE BEFORE PDF
  before <- list.files(path = file.path(dir, "Handouts"), full.names = TRUE) %>%
